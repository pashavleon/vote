-- Open Round of 16 match voting + block eliminated teams in winner/favorite.
-- Run after: resolve-r16-teams.sql + eliminated-teams.sql
    ...
    and exists (
      ...
      where po.id = poll_id
        ...
        and (
          ...
          or (m.id is not null and m.stage = 'r16')
        )
        and (
