-- Open Quarter-finals match voting + block eliminated teams in winner/favorite.
-- Run after: resolve-qf-teams.sql + eliminated-teams.sql
    ...
    and exists (
      ...
      where po.id = poll_id
        ...
        and (
          ...
          or (m.id is not null and m.stage = 'qf')
        )
        and (
